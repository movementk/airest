...
<body class="sub customer">
    ...
    <nav id="snb-menu">
        <ul class="snb-list">
            ...
            <li class="active"><a href="/mobile/customer/as_delivery.php">배송 및 A/S안내 <span></span></a></li>
    ...
    <main id="content" class="as-delivery">
        <div class="page-header">
            <div class="container">
                <h2>고객센터</h2>
                <a href="tel:15668903">1566-8903</a>
                <dl>
                    <dt>상담시간</dt>
            ...
            <div class="container">
                ...
                <dl>
                    ...
                    <dd>
                        <ul>
                            <li>주문 후 2~3일</li>
                            <li>도서·산간지역 3~4일 소요 (국/공휴일 제외)</li>
                        </ul>
                    </dd>
                </dl>
                <p class="attention">배송업체의 사정상 배송이 다소 지연될 수도 있음을 양지하여 주시기 바랍니다.</p>
                <p class="attention">제주, 섬지역은 도선료/항공료가 추가 될 수 있습니다.</p>
                <p class="attention">제품 특성상 묶음배송이 불가능하오니 참고해 주시기 바랍니다.</p>
            </div>
        </article>
                ...
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt>반송주소</dt>
                            <dd>
                                <address>인천광역시 연수구 하모니로 187번길 16 (송도동) 3층 (주)미로</address>
                            </dd>
                        </dl>
                    </li>
                </ul>
