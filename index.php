    ...
    <main id="content">
        ...
        <div class="jumbotron">
            <ul class="jumbo-slider">
                ...
                <li class="visual-list">
                    <div class="figbox">
                        <figure>
                            <img src="/assets/images/main/img_jumboslider02.jpg" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div class="product">
                        <div class="table-box">
                            <div class="v-align">
                                <figure>
                                    <img src="/assets/images/main/img_product_slide02.png" class="img-fluid" alt="">
                                </figure>
                                <div class="details">
                                    <h2>AIREST<br>PURIFIER</h2>
                                    <p>
                                        에어레스트는 소중한 아이이자 더 나아가 가족입니다<br>
                                        일상이 에어레스트가 되는 순간 행복한 고민에 빠지게 됩니다
                                    </p>
                ...
                <li class="visual-list">
                    <div class="figbox">
                        <figure>
                            <img src="/assets/images/main/img_jumboslider03.jpg" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div class="product">
                        <div class="table-box">
                            <div class="v-align">
                                <figure>
                                    <img src="/assets/images/main/img_product_slide03.png" class="img-fluid" alt="">
                                </figure>
                                <div class="details">
        ...
        <article class="video-area">
            <a href="#videoModal" data-toggle="modal" data-target="#videoModal">
                ...
                <p class="play-icon">
                    <i class="icon-googleplay">
                        <span class="sr-only">영상플레이</span>
                    </i>
                </p>
            </a>
        </article>
